                ...
                {group.logos.length > 0 ? (
                  ...
                  <div className="text-center py-12 border-2 border-dashed border-border rounded-lg">
                    <div className="text-muted-foreground">
                      ...
                      <h4 className="text-lg font-medium mb-2">Become a {group.tier} Sponsor</h4>
                      <p className="text-sm">
        ...
        <div className="mt-16 text-center">
          <Card>
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-foreground mb-4">Interested in Sponsoring?</h3>
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Join these amazing companies in supporting our maker community. Various sponsorship
