    ...
    const mockTemplates = [
      {
        ...
        description: 'Bold hero sections, track ribbons, and sponsor stripes. Perfect for maker festivals and technology events.',
        category: 'Events',
        preview: {
        ...
        allowedSections: [
          'hero', 'about', 'tracks', 'schedule', 'speakers', 
          'sponsors', 'venue', 'faq', 'custom-mdx'
        ],
        themeTokens: {
          colorScheme: 'vibrant',
          typography: 'modern',
      ...
      },
      {
        id: 'dark-tech',
        name: 'Dark Tech',
        description: 'Neon accents, glass morphism UI, and card-based grids. Ideal for tech conferences and hackathons.',
        category: 'Technology',
        preview: {
        ...
        allowedSections: [
          'hero', 'about', 'speakers', 'schedule', 'sponsors', 
          'venue', 'faq', 'custom-mdx'
        ],
        themeTokens: {
          colorScheme: 'dark',
      ...
      },
      {
        id: 'minimal-pro',
        name: 'Minimal Pro',
        description: 'Editorial typography, high contrast design, and clean layouts. Perfect for professional conferences.',
        category: 'Professional',
        preview: {
          thumbnail: 'https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?w=400&h=300&fit=crop',
          features: [
        ...
        allowedSections: [
          'hero', 'about', 'speakers', 'schedule', 'venue', 
          'faq', 'sponsors', 'custom-mdx'
        ],
        themeTokens: {
          colorScheme: 'minimal',
