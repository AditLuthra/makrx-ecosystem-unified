...
export async function GET(
  ...
  try {
    ...
    const dateFrom = searchParams.get('from') || new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString();
    ...
    const mockAnalytics = {
      ...
      revenue: {
        ...
        currency: 'USD',
        series: [
          { date: '2024-02-01', revenue: 1200.00, transactions: 12 },
          { date: '2024-02-02', revenue: 1800.00, transactions: 18 },
          { date: '2024-02-03', revenue: 2500.00, transactions: 25 },
          { date: '2024-02-04', revenue: 1500.00, transactions: 15 },
          { date: '2024-02-05', revenue: 3200.00, transactions: 32 },
          { date: '2024-02-06', revenue: 4100.00, transactions: 41 },
          { date: '2024-02-07', revenue: 2800.00, transactions: 28 }
        ],
        byEvent: [
          { eventSlug: '3d-printing-mastery', eventTitle: '3D Printing Mastery', revenue: 8900.00 },
          { eventSlug: 'autonomous-robot-competition', eventTitle: 'Robot Competition', revenue: 0.00 },
          { eventSlug: 'iot-sensors-workshop', eventTitle: 'IoT Workshop', revenue: 4500.00 }
        ]
      },
