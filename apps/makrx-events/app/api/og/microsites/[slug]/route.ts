...
export async function GET(
  ...
  try {
    ...
    const mockMicrosite = {
      ...
      title: title,
      subtitle: subtitle,
      description: 'Experience the future of making with hands-on workshops, competitions, and exhibitions.',
      theme: {
        primary: '#3B82F6',
        accent: '#8B5CF6',
        background: '#FFFFFF',
    ...
    const bgImage = mockMicrosite.heroImage 
      ? 'linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(' + mockMicrosite.heroImage + ')'
      : 'linear-gradient(135deg, ' + mockMicrosite.theme.primary + ', ' + mockMicrosite.theme.accent + ')';
