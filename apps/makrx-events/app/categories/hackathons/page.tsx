...
export default function HackathonsPage() {
  const hackathons = [
    ...
    },
    {
      ...
      description: "Build AI-powered solutions to improve healthcare accessibility, diagnosis, and patient care using machine learning and data science.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Intensive coding events where teams build innovative solutions in limited time. Perfect for rapid prototyping and learning.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {hackathons.map((hackathon) => (
            <Card key={hackathon.id} className="overflow-hidden hover:shadow-lg transition-shadow border-l-4 border-l-purple-500">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  <Button asChild size="sm" className="flex-1">
                    <Link href={`/events/${hackathon.id}`}>
                      View Details
                    </Link>
                  </Button>
                  <Button asChild size="sm" variant="default" className="flex-1 bg-purple-600 hover:bg-purple-700">
                    <Link href={`/events/${hackathon.id}/register`}>
                      Join Hackathon
                    </Link>
                  </Button>
                </div>
