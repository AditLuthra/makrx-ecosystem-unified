  ...
  const meetups = [
    {
      ...
      description: "Monthly gathering for makers, engineers, and entrepreneurs to share projects, network, and collaborate on future innovations.",
    ...
    },
    {
      ...
      description: "Empowering women in STEM through hands-on making workshops, mentorship, and community building sessions.",
      date: "April 8, 2024",
      location: "Austin, TX",
      attendees: 50,
      duration: "4 hours",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Connect with fellow makers, share experiences, and build lasting relationships in the maker community.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {meetups.map((meetup) => (
            <Card key={meetup.id} className="overflow-hidden hover:shadow-lg transition-shadow border-l-4 border-l-orange-500">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button asChild size="sm" variant="default" className="flex-1 bg-orange-600 hover:bg-orange-700">
                    <Link href={`/events/${meetup.id}/register`}>
                      Join Meetup
                    </Link>
                  </Button>
                </div>
