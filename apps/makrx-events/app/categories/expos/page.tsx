  ...
  const expos = [
    {
      ...
      description: "Exhibition of cutting-edge maker projects, prototypes, and innovations from creators worldwide. See the future of making today.",
      date: "May 18-20, 2024",
    ...
    },
    {
      ...
      description: "Discover the latest in hardware startups, emerging technologies, and investment opportunities in the maker ecosystem.",
      date: "June 5-7, 2024",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Discover the latest innovations, connect with industry leaders, and explore cutting-edge maker technologies.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {expos.map((expo) => (
            <Card key={expo.id} className="overflow-hidden hover:shadow-lg transition-shadow border-l-4 border-l-indigo-500">
