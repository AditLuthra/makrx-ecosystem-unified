      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <p>
              Track information is not available yet. Once the program is shaped, we&apos;ll publish the different themes
              and recommended sessions for each audience.
            </p>
          </CardContent>
        </Card>
        ...
        <MicrositeComingSoon
          ...
          description="Stay tuned for curated learning paths once the content is finalized."
        />
      </main>
    </div>
  );
