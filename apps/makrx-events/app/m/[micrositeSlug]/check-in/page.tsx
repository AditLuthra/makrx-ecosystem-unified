...
export default function CheckInPage() {
  ...
  const scanForQRCode = () => {
    ...
    if (video.readyState === video.HAVE_ENOUGH_DATA && context) {
      ...
      if (Math.random() < 0.1) {
        // 10% chance of detecting a QR code
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-500">Staff: Admin User</div>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Scan participant QR codes for quick check-in</CardDescription>
            </CardHeader>
                    ...
                    <AlertDescription className="ml-2">
                      ...
                      {lastResult.registration && (
                        <div className="mt-1 text-sm">
                          <strong>{lastResult.registration.participantName}</strong> -{' '}
                          {lastResult.registration.eventTitle}
                        </div>
                      )}
                    </AlertDescription>
                  </div>
