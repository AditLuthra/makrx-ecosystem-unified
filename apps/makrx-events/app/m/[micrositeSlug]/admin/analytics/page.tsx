...
async function getAnalyticsData(slug: string) {
  const mockData = {
    makerfest2024: {
      ...
      eventBreakdown: [
        { name: "Arduino Workshop", registrations: 234, revenue: 9360, capacity: 250, conversionRate: 15.2 },
        { name: "3D Printing Basics", registrations: 189, revenue: 0, capacity: 200, conversionRate: 12.8 },
        { name: "Robotics Competition", registrations: 156, revenue: 23400, capacity: 180, conversionRate: 18.4 },
        { name: "IoT Hackathon", registrations: 298, revenue: 7450, capacity: 300, conversionRate: 22.1 },
        { name: "Sustainable Design", registrations: 167, revenue: 5010, capacity: 200, conversionRate: 9.7 }
      ],
      demographics: {
        ageGroups: [
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold">${analytics.overview.avgRegistrationValue}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium">Waitlist Count</span>
                      <span className="text-lg font-bold text-orange-600">{analytics.overview.waitlistCount}</span>
                    </div>
                  </div>
                  <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    {analytics.demographics.locations.map((location) => (
                      <div key={location.city} className="flex items-center space-x-3">
                        ...
                        <div className="w-12 text-xs text-gray-500 text-right">({location.count})</div>
                      </div>
                    ))}
                  </div>
                </CardContent>
