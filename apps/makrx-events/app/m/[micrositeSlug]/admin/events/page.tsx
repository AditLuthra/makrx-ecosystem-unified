                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge 
                        variant="outline" 
                        className={
                          event.type === 'competition' ? 'border-blue-200 text-blue-700' :
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-gray-500">
                      ...
                      <div className="flex items-center">
                        <span className={`w-2 h-2 rounded-full mr-2 ${
                          event.registrationType === 'free' ? 'bg-green-500' :
                          event.registrationType === 'paid' ? 'bg-blue-500' :
                          'bg-gray-500'
                        }`}></span>
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <div className="flex flex-wrap gap-3">
              ...
              <Button asChild size="sm" variant="outline">
                <Link href={`/m/${micrositeSlug}/admin/events/bulk-import`}>
                  Import Events
                </Link>
              </Button>
              <Button asChild size="sm" variant="outline">
                <Link href={`/m/${micrositeSlug}/admin/events/templates`}>
                  Event Templates
                </Link>
              </Button>
            </div>
