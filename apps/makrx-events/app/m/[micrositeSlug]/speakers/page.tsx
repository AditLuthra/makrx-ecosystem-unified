  ...
  const speakers = [
    ...
    },
    {
      ...
      talk: {
        ...
        location: "Main Keynote Theater",
        description: "How maker communities are democratizing innovation and technology access worldwide."
      },
      social: {
        twitter: "@marcusmakes",
    ...
    },
    {
      ...
      talk: {
        ...
        description: "Hands-on workshop combining code and hardware for interactive art installations."
      },
      social: {
    ...
    },
    {
      ...
      talk: {
        ...
        description: "Lessons from building robots for space that apply to terrestrial maker projects."
      },
      social: {
    ...
    },
    {
      ...
      talk: {
        ...
        description: "Strategies for making maker technologies accessible across diverse communities."
      },
      social: {
    ...
    },
    {
      ...
      talk: {
        ...
        description: "How to incorporate environmental considerations into maker projects and electronics design."
      },
      social: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="flex items-center space-x-6">
              ...
              <Link href={`/m/${micrositeSlug}/tracks`} className="text-gray-700 hover:text-primary">
                Tracks
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Learn from industry leaders, researchers, and innovators shaping the future of making and technology.
          </p>
        </div>
                  ...
                  <div className="flex space-x-3">
                    {speaker.social.twitter && (
                      <Button variant="ghost" size="sm" asChild>
                        <a href={`https://twitter.com/${speaker.social.twitter.replace('@', '')}`} target="_blank">
                    ...
                    {speaker.social.linkedin && (
                      <Button variant="ghost" size="sm" asChild>
                        <a href={`https://linkedin.com/in/${speaker.social.linkedin}`} target="_blank">
            ...
            {featuredSpeakers.map((speaker) => (
              <Card key={speaker.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-3">
                  <p className="text-sm text-gray-700 text-center">{speaker.bio.slice(0, 120)}...</p>
        ...
        <Card className="mt-12 bg-gradient-to-r from-blue-50 to-purple-50 border-none">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Don't miss these incredible speakers and the opportunity to learn from the best in the maker community.
            </p>
            <Button asChild>
