  ...
  const workshops = [
    {
      ...
      description:
        'Comprehensive hands-on workshop covering 3D modeling with Fusion 360, printing techniques, material selection, and post-processing for makers of all levels.',
      date: 'May 5, 2024',
      location: 'Austin, TX',
      attendees: 50,
      duration: '6 hours',
    ...
    },
    {
      ...
      description:
        'Learn electronics fundamentals and Arduino programming. Build circuits, sensors, and interactive projects from scratch with guided instruction.',
      date: 'March 15, 2024',
      ...
      image:
        'https://images.unsplash.com/photo-1553835973-dec43bcddbeb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
    ...
    },
    {
      ...
      description:
        'Master laser cutting techniques and parametric design. Create custom enclosures, decorative items, and functional parts using professional tools.',
      date: 'April 12, 2024',
      location: 'Seattle, WA',
      attendees: 30,
      duration: '5 hours',
      ...
      image:
        'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Hands-on learning experiences with expert instructors. Build skills, create projects,
            and learn new technologies in small group settings.
          </p>
        </div>
            ...
            >
              <div className="aspect-video relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <Badge
                    className={`${
                      workshop.level.includes('Beginner')
                        ? 'bg-green-500'
                        : workshop.level.includes('Intermediate')
                          ? 'bg-yellow-500'
                          : 'bg-red-500'
                    } text-white`}
                  >
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">{workshop.includes.join(', ')}</div>
                </div>

                <div className="flex gap-2 pt-2">
                  <Button asChild size="sm" className="flex-1">
                    <Link href={`/events/${workshop.id}`}>Learn More</Link>
                  </Button>
                  <Button
                    asChild
                    size="sm"
                  ...
                  >
                    <Link href={`/events/${workshop.id}/register`}>Enroll</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
