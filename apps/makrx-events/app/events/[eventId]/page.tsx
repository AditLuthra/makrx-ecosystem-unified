...
import { Calendar, MapPin, Users, Clock, Trophy, Wrench, DollarSign, User, CheckCircle } from "lucide-react";
...
const getEventData = (eventId: string) => {
  const events = {
    "maker-fest-2024": {
      ...
      description: "Join thousands of makers, inventors, and technology enthusiasts for the largest maker festival on the West Coast. Experience hands-on workshops, competitive challenges, product exhibitions, and networking opportunities that will inspire your next creation.",
      fullDescription: "Maker Fest 2024 brings together the global maker community for three days of innovation, creativity, and collaboration. From seasoned engineers to curious beginners, this festival offers something for everyone interested in the intersection of technology, art, and craftsmanship.",
      type: "festival",
      ...
      schedule: [
        { day: "Day 1", events: ["Opening Ceremony", "Keynote: Future of Making", "Workshop Sessions", "Networking Mixer"] },
        { day: "Day 2", events: ["Competition Kickoff", "Maker Marketplace", "Live Demos", "Panel Discussions"] },
        { day: "Day 3", events: ["Final Presentations", "Awards Ceremony", "Community Showcase", "Closing Reception"] }
      ]
    },
    "robotics-championship": {
      ...
      description: "The premier robotics competition where teams design, build, and program autonomous robots to compete in challenging tasks. Open to students, professionals, and maker enthusiasts.",
      fullDescription: "Test your engineering and programming skills in this intense robotics competition. Teams have limited time and resources to build robots that can navigate obstacles, manipulate objects, and complete complex tasks autonomously.",
      type: "competition",
      date: "April 20, 2024",
      startTime: "8:00 AM",
      endTime: "8:00 PM",
    ...
    "3d-printing-workshop": {
      ...
      description: "Comprehensive hands-on workshop covering the complete 3D printing workflow. Learn 3D modeling, printing techniques, material selection, and post-processing methods.",
      fullDescription: "Master the art and science of 3D printing in this intensive workshop. Whether you're a complete beginner or looking to enhance your skills, you'll learn industry best practices and hands-on techniques from experienced instructors.",
      type: "workshop",
      date: "May 5, 2024",
      startTime: "9:00 AM", 
      endTime: "3:00 PM",
      ...
      <section className="relative h-[400px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
            <Badge 
              className={`mb-4 ${
                isFestival ? 'bg-purple-600' :
                isCompetition ? 'bg-red-600' : 'bg-green-600'
              }`}
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle>About This {event.type.charAt(0).toUpperCase() + event.type.slice(1)}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  {isWorkshop ? "What You'll Learn" : isFestival ? "Event Highlights" : "Competition Features"}
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-6">
                ...
                <div className="pt-4 space-y-2">
                  <Button asChild className="w-full">
                    <Link href={`/events/${event.id}/register`}>
                      {isCompetition ? "Enter Competition" : isWorkshop ? "Enroll Now" : "Register for Event"}
                    </Link>
                  </Button>
            ...
            {(event.schedule || event.topics) && (
              <Card>
                <CardHeader>
                  <CardTitle>
                    {isFestival ? "3-Day Schedule" : isCompetition ? "Competition Schedule" : "Workshop Agenda"}
                  </CardTitle>
                </CardHeader>
                <CardContent>
