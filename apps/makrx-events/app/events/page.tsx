  ...
  if (typeof window === 'undefined' || process.env.NEXT_PUBLIC_USE_MOCK_DATA === 'true') {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        <h1 className="text-3xl font-bold mb-4">Events (Static Export)</h1>
  ...
  const events = [
    {
      ...
      description:
        'Annual maker festival featuring competitions, workshops, and exhibitions showcasing innovative projects and technologies.',
      type: 'festival',
    ...
    },
    {
      ...
      description:
        'Competitive robotics event where teams build and program autonomous robots to complete challenging tasks.',
      type: 'competition',
      date: 'April 20, 2024',
      location: 'Boston, MA',
      attendees: 150,
    ...
    },
    {
      ...
      description:
        'Hands-on workshop covering 3D modeling, printing techniques, and post-processing for beginners and intermediate makers.',
      type: 'workshop',
      date: 'May 5, 2024',
      location: 'Austin, TX',
      attendees: 50,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Discover maker events including festivals, competitions, and workshops happening around
            the world.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                {event.subEvents.length > 0 && (
                  <div>
                    ...
                    <div className="text-xs text-gray-600">{event.subEvents.join(', ')}</div>
                  </div>
                )}
