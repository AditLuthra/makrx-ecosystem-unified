      ...
      <main className="relative z-10 pt-16">
        ...
        <section className="py-24 bg-gradient-to-br from-makr-blue/20 via-purple-600/20 to-makr-yellow/10 border-b border-makr-blue/30">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-dark-text-secondary max-w-2xl mx-auto font-mono">
              Everything you need to know to build with MakrX — guides, API references, best
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <span
                            className={`px-2 py-1 rounded text-xs flex items-center gap-1 font-mono ${getTypeColor(item.type)}`}
                          >
                          ...
                          {item.difficulty && (
                            <span
                              className={`px-2 py-1 rounded text-xs font-mono ${getDifficultyColor(item.difficulty)}`}
                            >
                              {item.difficulty}
                            </span>
                          )}
                        ...
                        <h3 className="text-lg font-semibold mb-1 text-gradient-cyberpunk font-mono">
                          {item.title}
                        </h3>
            ...
            <div className="max-w-6xl mx-auto px-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                {docSections.map((section) => (
                  <div
                    key={section.id}
                    className="card-cyberpunk overflow-hidden border border-makr-blue/30"
                  >
                    <div className="bg-gradient-to-r from-makr-blue/10 to-makr-yellow/10 p-6 border-b border-makr-blue/30">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h2 className="text-xl font-bold text-gradient-cyberpunk font-mono">
                            {section.title}
                          </h2>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex-1">
                                ...
                                <h3 className="font-semibold mb-1 text-gradient-cyberpunk font-mono">
                                  {item.title}
                                </h3>
        ...
        <section className="py-20 bg-gradient-to-r from-makr-blue/20 to-purple-600/20 border-t border-makr-blue/30">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-2xl font-bold mb-4 text-gradient-cyberpunk font-mono">
              Need Help?
            </h2>
