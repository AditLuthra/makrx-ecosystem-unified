      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 relative z-10">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-3 text-sm text-dark-text-muted font-mono">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+918047258000" className="hover:text-makr-blue">
                  +91 80472 58000
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-makr-blue" />
                <a href="mailto:hello@makrx.org" className="hover:text-makr-blue">
                  hello@makrx.org
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="hover:text-makr-blue"
                >
                  makrx.org
                </a>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {footerSections.map((section) => (
                <div key={section.title}>
                  <h3 className="text-lg font-semibold mb-4 text-gradient-cyberpunk font-mono">
                    {section.title}
                  </h3>
        ...
        <div className="border-t border-makr-blue/30 pt-12 mb-12">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-2xl font-bold mb-4 text-gradient-cyberpunk font-mono">
              Stay Updated with MakrX
            </h3>
            ...
            <p id="newsletter-description" className="text-xs text-dark-text-muted mt-3 font-mono">
              ...
              <Link
                href="/privacy"
                className="text-makr-yellow hover:text-makr-blue transition-colors"
              >
                Privacy Policy
              </Link>
            </p>
