...
export default function Header() {
  ...
  const { isAuthenticated, user, login, logout, isLoading } = useKeycloak();
            ...
            {isLoading ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-900 transition-colors"
                >
                  <div className="w-7 h-7 bg-makrx-blue rounded-full flex items-center justify-center">
                ...
                {showUserMenu && (
                  <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-slate-950 rounded-xl shadow-xl border border-gray-200 dark:border-slate-800 py-2 z-50">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-900 flex items-center gap-2"
                    >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200 dark:border-slate-800">
            <nav className="space-y-4">
              ...
              {/* Mobile Theme Toggle & Authentication */}
                ...
                {isAuthenticated && user ? (
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="block w-full px-4 py-2 bg-red-600 text-white rounded-lg text-sm font-medium text-center hover:bg-red-700 transition-colors"
                    >
                      Sign Out
                    </button>
                  </div>
