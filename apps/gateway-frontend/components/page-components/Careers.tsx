      ...
      <section className="bg-gradient-to-br from-makrx-blue to-purple-900 py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Join our team of passionate builders, designers, and innovators as we create the
            platform that empowers millions of makers worldwide.
          </p>
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="w-16 h-16 bg-makrx-blue/10 dark:bg-makrx-yellow/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <div className="text-makrx-blue dark:text-makrx-yellow">{benefit.icon}</div>
                </div>
      ...
      <section className="py-20 bg-makrx-blue dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join a team that's building the infrastructure for the next generation of makers and
            creators.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
