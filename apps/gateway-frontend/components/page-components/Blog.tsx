  ...
  const posts = [
    {
      ...
      excerpt:
        'Exploring how digital fabrication is transforming the maker ecosystem and enabling rapid innovation across industries.',
      author: 'Team MakrX',
      date: '2024-01-15',
    ...
    },
    {
      ...
      excerpt:
        'How TechSpace Mumbai transformed from a small community workshop to a thriving innovation hub using MakrCave.',
      author: 'Raj Kumar',
      date: '2024-01-05',
    ...
    },
    {
      ...
      excerpt:
        'Discover the latest materials and printing techniques that are pushing the boundaries of additive manufacturing.',
    ...
    },
    {
      ...
      excerpt:
        'Follow the inspiring story of how a weekend project became a successful product through the MakrX ecosystem.',
      author: 'Vikash Singh',
      date: '2023-12-28',
      category: 'Success Stories',
    ...
    },
    {
      ...
      excerpt:
        'Essential tips and tricks for getting started with laser cutting, from material selection to design optimization.',
      author: 'Sarah Chen',
      date: '2023-12-25',
      category: 'Tutorials',
      ...
      <section className="bg-white dark:bg-gray-800 py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 text-center max-w-3xl mx-auto">
            Insights, tutorials, and stories from the maker community. Stay updated with the latest
            in digital fabrication and innovation.
          </p>
