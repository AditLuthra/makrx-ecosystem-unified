        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              MakrX, operated by <strong>Botness Technologies Pvt Ltd</strong> ("we," "our," or
              "us"), is committed to protecting your privacy. This Privacy Policy explains how we
              collect, use, disclose, and safeguard your information when you use our platform,
              including makrx.org, MakrCave, MakrX Store, and related services.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              We comply with the{' '}
              <strong>Digital Personal Data Protection Act, 2023 (DPDP Act)</strong>, General Data
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                <li>
                  <strong>Service Delivery:</strong> Providing access to makerspaces, processing
                  orders, and managing memberships
                </li>
                <li>
                  <strong>Communication:</strong> Sending important updates, newsletters, and
                  customer support
                </li>
                <li>
                  <strong>Improvement:</strong> Analyzing usage patterns to enhance our platform and
                  services
                </li>
                <li>
                  <strong>Safety:</strong> Ensuring security and preventing fraud or misuse
                </li>
                <li>
                  <strong>Legal Compliance:</strong> Meeting regulatory requirements and legal
                  obligations
                </li>
              </ul>
            </div>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-1">
              <li>
                <strong>Partner Makerspaces:</strong> To facilitate bookings and access
              </li>
              <li>
                <strong>Service Providers:</strong> Payment processors, hosting services (with data
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <ul className="text-yellow-700 dark:text-yellow-400 space-y-2">
                  ...
                  <li>
                    <strong>Complaint:</strong> Report to data protection authorities
                  </li>
                </ul>
              </div>
              <p className="text-yellow-700 dark:text-yellow-400 mt-4">
                <strong>To exercise these rights:</strong> Email us at{' '}
                <a href="mailto:privacy@makrx.org" className="underline">
                  privacy@makrx.org
                </a>{' '}
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              (e.g., for cloud services), we ensure adequate protection through Standard Contractual
          ...
          <section className="mb-8">
            ...
            <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-lg p-4">
              <p className="text-red-800 dark:text-red-300">
                <strong>Our services are not intended for children under 18.</strong> We do not
                knowingly collect personal information from minors. If you believe we have collected
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                    Email:{' '}
                    <a href="mailto:dpo@makrx.org" className="text-makrx-blue underline">
                      dpo@makrx.org
                    </a>
                    <br />
