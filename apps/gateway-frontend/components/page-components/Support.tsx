  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        "Getting started is easy! First, create your account at auth.makrx.org. Choose your role (Maker, Makerspace Owner, or Service Provider) and you'll be guided through the appropriate onboarding process. Check out our Quick Start Guide for detailed instructions.",
      category: 'Getting Started',
    },
    {
      question: "What's included in a MakrCave subscription?",
      answer:
        'MakrCave subscriptions include equipment booking, inventory management, member billing, project tracking, and analytics. Pricing varies by makerspace size and features needed. Contact our sales team for a custom quote.',
      category: 'Billing',
    },
    {
      question: 'How do I place a custom manufacturing order?',
      answer:
        'Upload your design files to our Store platform and get an instant quote. You can choose from 3D printing, CNC machining, laser cutting, and PCB assembly services. Our global provider network ensures competitive pricing and fast delivery.',
      category: 'Orders',
    },
    {
      question: 'What payment methods do you accept?',
      answer:
        'We accept all major credit cards, UPI, net banking, and wire transfers. Enterprise customers can also request invoice-based billing with payment terms. All transactions are secured with bank-level encryption.',
      category: 'Billing',
    },
    {
      question: 'How do I book equipment at a makerspace?',
      answer:
        "Browse available makerspaces in your area, view their equipment and availability, then book time slots directly through our platform. You'll receive confirmation and access instructions via email and SMS.",
      category: 'Bookings',
    },
    {
      question: 'Can I integrate MakrX with my existing systems?',
      answer:
        'Yes! We offer REST APIs and webhooks for integration with existing tools. Enterprise customers also get access to our dedicated integration support team. Check our developer documentation for detailed guides.',
      category: 'Technical',
    },
  ];
            ...
            {contactOptions.map((option, index) => (
              ...
              >
                <div className="w-16 h-16 bg-makrx-blue/10 dark:bg-makrx-yellow/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <div className="text-makrx-blue dark:text-makrx-yellow">{option.icon}</div>
                </div>
