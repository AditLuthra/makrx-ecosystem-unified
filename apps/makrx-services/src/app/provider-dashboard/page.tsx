          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8 px-6">
              {[
                ...
                {
                  key: "jobs",
                  label: `Available Jobs (${availableJobs.length})`,
                  icon: Bell,
                },
                {
                  key: "active",
                  label: `Active Jobs (${acceptedJobs.filter((j) => !["completed", "delivered"].includes(j.status)).length})`,
                  icon: Package,
                },
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-blue-600">
                      +{stats.this_week_jobs} this week
                    </p>
                  </div>
              ...
              <div className="provider-metric-card">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900">
                      {Math.floor(stats.response_time_minutes / 60)}h{" "}
                      {stats.response_time_minutes % 60}m
                    </p>
                  ...
                  {availableJobs.slice(0, 3).map((job) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-makrx-teal">
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-500">
                          {formatDateRelative(job.accepted_at)}
                        </p>
                      </div>
                    </div>
                  ))}
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs text-red-600">
                            Low stock: {item.current_stock.toFixed(2)} units
                          </p>
                        </div>
                      </div>
                    ))}
          ...
          <div className="bg-white rounded-lg shadow-sm">
            <div className="px-6 py-4 border-b flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  First-accept-first-serve system
                </p>
              </div>
              <button
                        ...
                        {job.dimensions && (
                          <div className="col-span-2">
                            ...
                            <p className="text-gray-900">
                              {job.dimensions.x} × {job.dimensions.y} ×{" "}
                              {job.dimensions.z} mm
                            </p>
                          </div>
                        )}
                                ...
                                >
                                  ...
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <p className="text-gray-500 text-xs">
                                      {formatDateRelative(update.timestamp)}
                                    </p>
                                  </div>
                                </div>
                              ))}
            ...
            <div className="px-6 py-4 border-b">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Manage your material stock levels
                  </p>
                </div>
            ...
            <div className="p-6">
              {inventory.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-600 mb-6">
                    Add materials to track your stock levels.
                  </p>
                    ...
                    >
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Last updated:{" "}
                            {formatDateRelative(item.last_updated)}
                          </p>
                        </div>
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-sm text-gray-600">
                            {(
                              (item.current_stock /
                                Math.max(item.minimum_stock * 3, 1)) *
                              100
                            ).toFixed(0)}
                            %
                          </span>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <button
                            onClick={() =>
                              updateInventory(item.id, 1, "subtract")
                            }
