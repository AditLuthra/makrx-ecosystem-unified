...
const nextConfig = {
  ...
  async rewrites() {
    const servicesApi =
      process.env.NEXT_PUBLIC_SERVICES_API_URL || "http://localhost:8006/api";
    const storeApi =
      process.env.NEXT_PUBLIC_STORE_API_URL || "http://localhost:8004/api";
    return [
  ...
  env: {
    ...
    NEXT_PUBLIC_SERVICES_URL:
      process.env.NEXT_PUBLIC_SERVICES_URL || "http://localhost:3005",
