    ...
    <div className="p-6 space-y-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={() => window.open(`/portal/projects/${projectId}`, '_blank')}
              >
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {project.is_featured && <Star className="h-5 w-5 text-yellow-500 fill-current" />}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              ...
              <div className="flex flex-col items-center space-y-1">
                ...
                <span className="text-lg font-semibold">
                  {project.equipment_reservations.length}
                </span>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <ProjectActivity activities={project.activity_logs.slice(0, 5)} showAll={false} />
              </CardContent>
            </Card>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    {' ' + project.collaborators.filter((c) => c.role === 'editor').length}{' '}
                    editor(s), and
                    {' ' + project.collaborators.filter((c) => c.role === 'viewer').length}{' '}
                    viewer(s)
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    {' ' +
                      project.bom_items.filter((b) => b.procurement_status === 'received')
                        .length}{' '}
                    received
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm">
                    ...
                    {' ' +
                      project.equipment_reservations.filter((e) => e.status === 'confirmed')
                        .length}{' '}
                    confirmed,
                    {' ' +
                      project.equipment_reservations.filter((e) => e.status === 'completed')
                        .length}{' '}
                    completed
                  </p>
                </div>
        ...
        <TabsContent value="activity">
          <ProjectActivity activities={project.activity_logs} showAll={true} />
        </TabsContent>
