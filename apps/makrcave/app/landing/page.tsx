...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 w-full max-w-full overflow-x-hidden">
      {/* Public Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <div className="block p-2 bg-blue-500/20 rounded-md">
                      ...
                      <div className="text-sm text-blue-300/70">
                        You are here - Makerspace management
                      </div>
                    </div>
                    <a
                      href="https://makrx.store"
                      className="block p-2 hover:bg-white/10 rounded-md"
                    >
              ...
              <a href="#institutions" className="text-white/80 hover:text-white transition-colors">
                Institutions
              </a>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 py-16 sm:py-24 lg:py-32 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-white/80 mb-8 sm:mb-12 leading-relaxed max-w-3xl mx-auto">
              The heart of the MakrX ecosystem: comprehensive management for inventory, equipment,
              skills, service orders, and community collaboration — all in one powerful platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center max-w-lg sm:max-w-none mx-auto">
              <Link href="/find-makerspace">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white border-none text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4"
                >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/30 text-white hover:bg-white/10 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4"
              >
      ...
      <section className="py-24 bg-black/20">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">What is MakrCave?</h2>
            <p className="text-xl text-white/80 leading-relaxed mb-4">
              The comprehensive makerspace management platform within the MakrX ecosystem —
              connecting makers with the tools, resources, and community they need to bring ideas to
              life.
            </p>
            <p className="text-lg text-white/70 leading-relaxed">
              A complete solution for running any makerspace with integrated business operations,
              community building, service provider capabilities, and seamless connections to
              MakrX.org and MakrX.Store.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Auto-tracking with MakrX.Store integration',
              },
              { icon: '🏗️', label: 'Project Hub', desc: 'BOMs, collaboration & ecosystem sync' },
              {
                icon: '📅',
                label: 'Equipment Access',
                desc: 'Skill-gated booking & safety control',
              },
              {
                icon: '⚙️',
                label: 'Service Orders',
                desc: 'Full fabrication job lifecycle management',
              },
            ].map((item, idx) => (
      ...
      <section id="explore" className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Enter the MakrVerse</h2>
                  ...
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                    <div className="text-center">
                      <h3 className="text-3xl font-bold text-white mb-4">
                        Google Earth for Makers
                      </h3>
                      <p className="text-lg text-white/80 mb-6 max-w-md">
                        Watch real-time projects, discover AR exploration points, and earn travel
                        badges
                      </p>
                      <Link href="/makrverse">
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-white/70">
                  Real-time view of all MakrCaves, active projects, and running machines worldwide
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-white/70">
                  Discover hidden AR points, explore maker history, and unlock future visions
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-white/70">
                  Earn achievements as you explore caves, connect with makers, and discover new
                  technologies
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-24 bg-black/20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Who Is It For?</h2>
            <p className="text-xl text-white/80">
              MakrCave serves four primary roles in the makerspace ecosystem
            </p>
          </div>
      ...
      <section className="py-24 bg-black/20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/80">
              Seamlessly connected across the unified platform for makers
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'MakrX.Store',
                description:
                  'Integrated e-commerce: instant BOM ordering, quick reorders, and automated material procurement',
              },
              {
                icon: '🌍',
                title: 'MakrX.org',
                description:
                  'Unified ecosystem gateway: single sign-on, maker profiles, and global makerspace discovery',
              },
              {
                icon: '🎓',
              ...
              },
              {
                ...
                description:
                  'Machine access control via NFC, QR codes, and biometric authentication',
              },
              {
                icon: '🔄',
                title: 'Slicing APIs',
      ...
      <section id="features" className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Inside the System</h2>
            ...
            {[
              {
                ...
                description:
                  'Machines require specific skill badges with NFC/QR/fingerprint access control',
              },
              {
                icon: <Zap className="h-8 w-8" />,
                title: 'Smart Inventory Management',
                description:
                  'Track filament rolls, auto-deduction, low stock alerts, quick MakrX.Store reorders',
              },
              {
                icon: <Users className="h-8 w-8" />,
                title: 'Project & BOM Management',
                description:
                  'Team collaboration with BOMs linked directly to MakrX.Store product codes',
              },
              {
                icon: <Star className="h-8 w-8" />,
                title: 'Job Management System',
                description:
                  'Service providers receive jobs, upload G-code, track materials automatically',
              },
              {
                icon: <ArrowRight className="h-8 w-8" />,
                title: 'Equipment Reservations',
                description:
                  'Book machines with cost rules: free for members, paid per hour, or subscription included',
              },
              {
                icon: <MapPin className="h-8 w-8" />,
                title: 'Membership & Analytics',
                description:
                  'Membership plans, usage reports, equipment utilization, revenue tracking',
              },
            ].map((feature, idx) => (
              <Card
                key={idx}
      ...
      <section className="py-24 bg-black/20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">The Movement</h2>
            <blockquote className="text-2xl md:text-3xl text-white/90 italic mb-8 leading-relaxed">
              "Open making. Real skills. Shared knowledge. Join the mission to make making
              accessible to everyone, everywhere."
            </blockquote>
            <p className="text-xl text-white/80 mb-8">
              We're not just building a platform — we're creating a revolution in how people learn,
                ...
                {[
                  {
                    ...
                    desc: 'Track usage, engagement, and learning outcomes across all equipment',
                  },
                  {
                    title: 'Skill-Based Access',
                    desc: 'Automated safety protocols with competency verification',
                  },
                  {
                    title: 'Integrated Learning',
                    desc: 'Connected to the global MakrX ecosystem and community',
                  },
                  {
                    title: 'Scalable Platform',
                    desc: 'Enterprise-grade infrastructure that grows with your institution',
                  },
                ].map((benefit, idx) => (
              ...
              {[
                {
                  step: '01',
                  title: 'Apply',
                  desc: 'Submit your makerspace to join the MakrX ecosystem',
                },
                {
                  step: '02',
                  title: 'Setup',
                  desc: 'Complete integration with ecosystem support and training',
                },
                {
                  step: '03',
                  title: 'Launch',
                  desc: 'Go live as part of the global MakrX network',
                },
              ].map((step, idx) => (
                <div key={idx} className="text-center">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                quote:
                  'MakrCave transformed how our engineering students learn. The skill-gated access ensures safety while encouraging exploration.',
              ...
              {
                quote:
                  'As a makerspace owner, the analytics and automated systems have doubled our efficiency and member satisfaction.',
              ...
              {
                quote:
                  "The community aspect is incredible. I've learned more in 6 months than I did in years of solo tinkering.",
                author: 'Alex Rivera',
                role: 'Hobbyist Maker',
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/70">
                <li>
                  <Link href="/find-makerspace" className="hover:text-white transition-colors">
                    Find MakrCave
                  </Link>
                </li>
                <li>
