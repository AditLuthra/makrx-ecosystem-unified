      ...
      <CardContent>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div>
            ...
            <div className="font-medium">{envInfo.browser}</div>
          </div>
          <div>
            <span className="text-muted-foreground">Platform:</span>
            <div className="font-medium">{envInfo.platform}</div>
          </div>
          <div>
            <span className="text-muted-foreground">Language:</span>
            <div className="font-medium">{envInfo.language}</div>
          </div>
          <div>
            <span className="text-muted-foreground">Online:</span>
            <div className="font-medium">{envInfo.online}</div>
          </div>
          <div>
            <span className="text-muted-foreground">Screen:</span>
            <div className="font-medium">{envInfo.screen}</div>
          </div>
          <div>
            <span className="text-muted-foreground">Timezone:</span>
            <div className="font-medium">{envInfo.timezone}</div>
          </div>
          <div>
            <span className="text-muted-foreground">Memory:</span>
            <div className="font-medium">{envInfo.memory}</div>
          </div>
          <div>
            <span className="text-muted-foreground">Connection:</span>
            <div className="font-medium">{envInfo.connection}</div>
          </div>
        </div>
      </CardContent>
    </Card>
