...
const defaultFlags: FeatureFlag[] = [
  {
    id: 'dashboard.newAnalytics',
    name: 'New Analytics',
    description: 'Enable new analytics widgets',
    enabled: true,
  ...
  {
    id: 'projects.publicShowcase',
    name: 'Public Showcase',
    description: 'Enable project showcase',
    enabled: true,
    allowedRoles: ['user', 'service_provider', 'makerspace_admin', 'admin', 'super_admin'],
    environment: 'all',
    updatedAt: now,
  },
  {
    id: 'admin.makerspaces',
    name: 'Makerspaces Admin',
    description: 'Manage makerspaces',
    enabled: true,
