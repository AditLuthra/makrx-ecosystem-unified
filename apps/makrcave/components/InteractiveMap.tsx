    ...
    equipment: [
      {
        ...
        type: '3d_printer',
        status: 'available',
        specifications: { build_volume: '250×210×210mm' },
      },
      {
        id: 'e2',
        name: 'Ultimaker S5',
        ...
        specifications: { build_volume: '330×240×300mm' },
      },
      {
        id: 'e3',
        name: 'Universal Laser VLS2.30',
        type: 'laser_cutter',
        status: 'available',
        specifications: { bed_size: '610×305mm' },
      },
      {
        id: 'e4',
        ...
        type: 'cnc',
        status: 'maintenance',
        specifications: { work_area: '254×140×254mm' },
      },
    ],
    ...
    equipment: [
      {
        ...
        type: '3d_printer',
        status: 'available',
        specifications: { build_volume: '220×220×250mm' },
      },
      {
        id: 'e6',
        name: 'Glowforge Pro',
        ...
        specifications: { bed_size: '279×495mm' },
      },
      {
        id: 'e7',
        name: 'Shapeoko 4',
        type: 'cnc',
        status: 'available',
        specifications: { work_area: '610×610×75mm' },
      },
    ],
    image: '/api/placeholder/400/250',
  },
    ...
    equipment: [
      {
        ...
        type: '3d_printer',
        status: 'available',
        specifications: { build_volume: '335×200×300mm' },
      },
      {
        id: 'e9',
        ...
        type: 'laser_cutter',
        status: 'available',
        specifications: { bed_size: '812×508mm' },
      },
      {
        id: 'e10',
        name: 'Haas Mini Mill',
        type: 'cnc',
        status: 'available',
        specifications: { work_area: '406×254×254mm' },
      },
    ],
    image: '/api/placeholder/400/250',
  },
  ...
  const MapViewComponent = () => (
    <div className="relative h-96 bg-gray-100 rounded-lg overflow-hidden">
      ...
      {filteredMakerspaces.map((space, index) => (
        ...
        >
          <div
            className={`relative p-2 rounded-full shadow-lg transition-transform hover:scale-110 ${
              space.status === 'open'
                ? 'bg-green-500'
                : space.status === 'busy'
                  ? 'bg-yellow-500'
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Discover available tools and book time at local makerspaces
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-sm">
                  <div className="flex items-center gap-1">
                    <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                    <span>
                      {selectedSpace.rating} ({selectedSpace.reviewCount} reviews)
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      {selectedSpace.currentUsers}/{selectedSpace.capacity}
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full transition-all ${
                        selectedSpace.currentUsers / selectedSpace.capacity > 0.8
                          ? 'bg-red-500'
                          : selectedSpace.currentUsers / selectedSpace.capacity > 0.6
                            ? 'bg-yellow-500'
                            : 'bg-green-500'
                      }`}
                      style={{
                        width: `${(selectedSpace.currentUsers / selectedSpace.capacity) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    {selectedSpace.equipment.map((equipment) => (
                      <div key={equipment.id} className="flex items-center justify-between text-sm">
                        ...
                        <div
                          className={`flex items-center gap-1 ${getEquipmentStatusColor(equipment.status)}`}
                        >
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Select a Makerspace</h3>
                  <p className="text-gray-600">
