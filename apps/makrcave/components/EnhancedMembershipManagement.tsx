...
const EnhancedMembershipManagement: React.FC = () => {
  ...
  const loadPermissions = useCallback(async () => {
    try {
      const response = await fetch('/api/access-control/permissions/', { headers: await getHeaders() });
      if (response.ok) {
        const data = await response.json();
        setPermissions(data);
      }
  ...
  const loadStats = useCallback(async () => {
    try {
      const response = await fetch('/api/access-control/analytics/access-control', { headers: await getHeaders() });
      if (response.ok) {
        const data = await response.json();
        setStats(data);
      }
  ...
  const loadSecurityAlerts = useCallback(async () => {
    try {
      const response = await fetch('/api/access-control/security-alerts/?resolved=false', { headers: await getHeaders() });
      if (response.ok) {
        const data = await response.json();
