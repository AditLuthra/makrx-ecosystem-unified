...
const EnhancedMembershipManagement: React.FC = () => {
  ...
  const renderMemberCard = (member: EnhancedMember) => (
    <Card
      key={member.id}
      className={`mb-4 ${!member.can_access_makerspace ? 'border-red-200 bg-red-50' : ''}`}
    >
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              {role.is_system && <Badge className="bg-blue-100 text-blue-800">System</Badge>}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {membershipPlans.map((plan) => (
                  <Card key={plan.id} className="p-4">
                    ...
                    <div className="text-sm text-gray-500 mb-2">{plan.member_count} members</div>
