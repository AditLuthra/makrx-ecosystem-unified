      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        ...
        <Card
          className={`cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-105 ${
            selectedCategory === '' ? 'ring-2 ring-blue-500 shadow-lg scale-105' : ''
          }`}
        ...
        >
          <CardContent className="p-4">
            <div className="text-center space-y-3">
              <div
                className={`w-12 h-12 mx-auto rounded-xl bg-gradient-to-br from-gray-400 to-gray-600 flex items-center justify-center shadow-lg`}
              >
          ...
          return (
            ...
            >
              <CardContent className="p-4">
                <div className="text-center space-y-3">
                  <div
                    className={`w-12 h-12 mx-auto rounded-xl bg-gradient-to-br ${getCategoryColor(category)} flex items-center justify-center shadow-lg`}
                  >
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div
                className={`w-8 h-8 rounded-lg bg-gradient-to-br ${getCategoryColor(selectedCategory)} flex items-center justify-center`}
              >
            ...
            <Badge className="bg-blue-600">{getProjectCount(selectedCategory)} projects</Badge>
          </div>
        </div>
      )}
    </div>
