      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Configure and optimize individual zones for maximum efficiency
          </p>
        </div>
            ...
            >
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <StatusIcon
                    className={`h-5 w-5 ${
                      efficiency.utilization >= 90
                        ? 'text-red-500'
                        : efficiency.utilization >= 75
                          ? 'text-orange-500'
                          : 'text-green-500'
                    }`}
                  />
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-bold text-purple-600">{zone.equipment_count}</div>
                  ...
                  <div className="mt-4 pt-4 border-t space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <Input value={zone.max_capacity} disabled={!editMode} className="mt-1" />
                      </div>
                      <div>
                        <label className="text-gray-600">Equipment Slots</label>
                        <Input value={zone.equipment_count} disabled={!editMode} className="mt-1" />
                      </div>
                    </div>
