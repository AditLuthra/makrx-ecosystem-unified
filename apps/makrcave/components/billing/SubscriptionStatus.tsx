...
import { Crown, Calendar, CheckCircle, AlertTriangle, ArrowUpRight } from 'lucide-react';
...
const SubscriptionStatus: React.FC<SubscriptionStatusProps> = ({ subscription, onUpgrade }) => {
