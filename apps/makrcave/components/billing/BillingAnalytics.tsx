...
const BillingAnalytics: React.FC<BillingAnalyticsProps> = ({
  ...
  const mockData: AnalyticsData = {
    ...
    revenue_by_month: [
      { month: 'Jan', revenue: 3760.4, transactions: 28 },
      { month: 'Feb', revenue: 4120.8, transactions: 31 },
      { month: 'Mar', revenue: 3850.25, transactions: 29 },
      { month: 'Apr', revenue: 4680.3, transactions: 35 },
      { month: 'May', revenue: 4230.75, transactions: 33 },
      { month: 'Jun', revenue: 4778.0, transactions: 38 },
    ],
    top_customers: [
      {
  ...
  const revenueByTypeData = Object.entries(analyticsData.revenue_by_type).map(([type, amount]) => ({
    ...
    amount,
    percentage:
      (amount / Object.values(analyticsData.revenue_by_type).reduce((a, b) => a + b, 0)) * 100,
  }));

  const paymentMethodsData = Object.entries(analyticsData.payment_methods).map(
    ([method, percentage]) => ({
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {analyticsData.transactions.total_count}
                </p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatPercentage(analyticsData.transactions.success_rate)}
                </p>
                <p className="text-sm text-gray-500 mt-1">
                  {analyticsData.transactions.successful_count}/
                  {analyticsData.transactions.total_count} successful
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  +
                  {formatPercentage(
                    ((analyticsData.revenue.monthly - analyticsData.revenue.previous_period) /
                      analyticsData.revenue.previous_period) *
                      100,
                  )}{' '}
                  from last month
                </p>
            ...
            <div className="flex items-center justify-between p-4 bg-red-50 border border-red-200 rounded-lg">
              <div>
                ...
                <p className="text-2xl font-bold text-red-900">
                  {analyticsData.transactions.failed_count}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-900">
                  {analyticsData.transactions.pending_count}
                </p>
              </div>
