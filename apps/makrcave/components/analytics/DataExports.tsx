  ...
  const exportItems: ExportItem[] = [
    {
      ...
      description:
        'Complete inventory list with stock levels, categories, and supplier information',
  ...
  const exportAnalyticsData = async (exportItem: ExportItem) => {
    ...
    if (!response.ok) {
      ...
      generateCSV(
        mockData.headers,
        mockData.data,
        `${exportItem.id}_${new Date().toISOString().split('T')[0]}`,
      );
      return;
    }
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              <Select
                value={exportFormat}
                onValueChange={(value: 'csv' | 'pdf' | 'xlsx') => setExportFormat(value)}
              >
                <SelectTrigger>
