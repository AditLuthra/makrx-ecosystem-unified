        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              connecting creators with the tools, services, and community they need to build the
              future.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                We believe that everyone should have access to the tools and knowledge needed to
                bring their ideas to life. From hobbyists to enterprises, we're democratizing
                manufacturing and empowering the next generation of creators.
              </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Making advanced manufacturing accessible to creators worldwide
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Curating only the best tools and services for our community
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Have questions about our platform or want to partner with us? We'd love to hear from
                you.
              </p>
