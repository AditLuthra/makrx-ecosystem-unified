      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Fast, reliable shipping for makers worldwide. Get your tools and materials delivered
            when you need them.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                All orders include real-time tracking from dispatch to delivery. You&apos;ll
                receive:
              </p>
              ...
              <p className="mt-4">
                Track your orders anytime at{' '}
                <Link href="/track" className="text-blue-600 dark:text-blue-400 hover:underline">
                  makrx.store/track
                </Link>
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Address changes are possible within 2 hours of placing your order. Contact our
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  We ship to most PIN codes across India. Remote locations may require additional
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  All packages are insured. Report any damage within 48 hours of delivery for
