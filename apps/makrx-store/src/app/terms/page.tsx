        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              By accessing and using MakrX Store ("we," "our," or "us"), you accept and agree to be
            ...
            <p className="text-gray-700 mb-4">
              Permission is granted to temporarily download one copy of the materials on MakrX
              Store's website for personal, non-commercial transitory viewing only. This is the
            ...
            <p className="text-gray-700 mb-4">
              ...
              PayPal, and other payment methods as indicated on our platform. All prices are in USD
              unless otherwise specified.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Shipping and Returns</h2>
            <p className="text-gray-700 mb-4">
              Shipping costs and delivery times vary by location and service level. Returns are
              accepted within 30 days of delivery for eligible items. Custom 3D printed items may
            ...
            <p className="text-gray-700 mb-6">
              The materials on MakrX Store's website are provided on an 'as is' basis. MakrX Store
            ...
            <p className="text-gray-700 mb-6">
              In no event shall MakrX Store or its suppliers be liable for any damages (including,
              without limitation, damages for loss of data or profit, or due to business
              interruption) arising out of the use or inability to use the materials on MakrX
              Store's website, even if MakrX Store or an authorized representative has been notified
              orally or in writing of the possibility of such damage.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Intellectual Property</h2>
            <p className="text-gray-700 mb-6">
              You retain all rights to any content you upload to our platform. By uploading content,
              you grant us a limited license to process, store, and fulfill your orders. We respect
