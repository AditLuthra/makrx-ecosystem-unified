...
const designTips = [
  {
    ...
    content:
      'Minimum wall thickness varies by material and process. 3D printing: 0.8mm for FDM, 0.4mm for SLA. CNC: 0.5mm for metals, 1mm for plastics.',
    category: 'Design',
  },
  {
    title: 'Hole Sizes and Threading',
    content:
      'Use standard drill sizes for holes. Minimum hole diameter: 0.5mm for laser cutting, 1mm for CNC. Threading requires minimum M3 for 3D prints.',
    category: 'Features',
  },
  {
    title: 'Surface Finish Options',
    content:
      'As-machined, bead blasted, anodized, powder coated. Each finish affects final dimensions - account for coating thickness.',
    category: 'Finishing',
  },
  {
    title: 'Draft Angles',
    content:
      'Add 1-2° draft angles for injection molding. Not required for additive manufacturing or CNC but can improve surface quality.',
    category: 'Design',
  },
  {
    title: 'Fillet and Chamfer Radii',
    content:
      'Minimum fillet radius: 0.5mm for CNC, 0.3mm for 3D printing. Sharp internal corners can cause stress concentrations.',
    category: 'Features',
  },
];
...
export default function SizeGuidePage() {
  ...
  const filteredTips = designTips.filter(
    (tip) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Complete reference for size limits, tolerances, and design guidelines across all our
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            {selectedChart && (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">{selectedChart.description}</p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
              ...
              <p className="text-blue-700 dark:text-blue-400 mb-4">
                If your project requires specifications outside our standard capabilities, our
                engineering team can work with you to find a solution.
              </p>
