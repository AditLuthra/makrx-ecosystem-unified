          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <p className="text-store-text-light">
                <span className="font-semibold text-store-text">{filteredProducts.length}</span> of{' '}
                {categoryProductsCount} products
                    ...
                    {viewMode === 'grid' ? (
                      <>
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-2">
                              <span className="font-bold text-store-text">${product.price}</span>
                              {product.sale_price && (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button disabled={compareList.length < 2}>Compare Now</Button>
              </div>
            </div>
          </div>
        </div>
