...
import { Order, Address, OrderItem } from '@/services/storeApi';
  ...
  const order: MockOrder = {
    ...
    items: [
      ...
      },
      {
        ...
        total_price: products[3].price * 2,
    ...
    created_at: '2024-01-15T10:30:00Z',
    // Additional mock data to match the original structure
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <h1 className="text-3xl font-bold text-store-text">Order {order.order_number}</h1>
              <div className="flex items-center gap-4 mt-2">
                ...
                <span className="text-store-text-muted">Placed {formatDate(order.created_at)}</span>
                <span className="text-store-text-muted">${order.total.toFixed(2)} total</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-store-text">${order.tax_amount.toFixed(2)}</span>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="text-sm text-store-text-muted space-y-1">
                  <p className="font-medium text-store-text">{order.addresses.shipping.name}</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-store-text">
                      {order.payment_method} •••• {order.payment?.last4}
                    </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-store-text">{order.email}</span>
                  </div>
                  {order.addresses.shipping.phone && (
                    <div className="flex items-center gap-2">
                      <Phone className="h-4 w-4 text-store-text-muted" />
                      <span className="text-store-text">{order.addresses.shipping.phone}</span>
                    </div>
                  )}
                </div>
              </div>
