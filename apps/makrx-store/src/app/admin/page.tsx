    ...
    <Layout>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* Stats Grid */}
          {statsNotice && (
            <div className="mb-4 rounded border border-yellow-300 bg-yellow-50 p-4 text-sm text-yellow-800">
              <div className="flex items-start justify-between">
                <p>{statsNotice}</p>
                <button
                  onClick={() => setStatsNotice(null)}
                  className="ml-4 text-yellow-700 hover:underline"
                >
                  Dismiss
                </button>
              </div>
