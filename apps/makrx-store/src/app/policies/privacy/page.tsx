                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      At MakrX Store, we are committed to protecting your privacy and ensuring the
                      security of your personal information. This policy explains how we collect,
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-600 mb-4">When you use our 3D printing services:</p>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-600">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-400 pl-6">
                  ...
                  <p className="text-gray-600 mb-3">
                    We share information with trusted third parties who help us operate our
                    business:
                  </p>
                ...
                <div className="border-l-4 border-purple-400 pl-6">
                  ...
                  <p className="text-gray-600">
                    ...
                    be transferred as part of the business transaction. We will notify you of any
              ...
              <div className="space-y-6">
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Help us understand how visitors use our website so we can improve the user
                        experience.
                      </p>
                    </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    You can control cookies through your browser settings or our cookie preference
                    center. Note that disabling certain cookies may affect website functionality.
                  </p>
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      MakrX Store operates primarily in the United States. If you are located
                      outside the US, your information may be transferred to and processed in the
                      United States where our servers and business operations are located.
                    </p>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          We comply with GDPR requirements for European users, including lawful
                          basis for processing and enhanced user rights.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          ...
                          transfers through standard contractual clauses and other approved
                          mechanisms.
                        </p>
                      </div>
                    </div>
