    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="quote" disabled={!selectedFile}>
            Quote
          </TabsTrigger>
        </TabsList>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setPrintOptions((prev) => ({ ...prev, quality: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setPrintOptions((prev) => ({ ...prev, priority: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
