        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <nav className="hidden md:flex items-center space-x-3 lg:space-x-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-64 bg-popover border border-border shadow-xl rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform scale-95 group-hover:scale-100 z-50 backdrop-blur-sm dark:bg-gray-900/95">
