        ...
        with engine.connect() as conn:
            ...
            prerequisites = [
                (
                    "skill-4",
                    "skill-1",
                ),  # Advanced 3D Printing requires basic 3D Printer Operation
                (
                    "skill-3",
                    "skill-5",
                ),  # CNC Operation requires Material Handling
                (
                    "skill-6",
                    "skill-3",
                ),  # G-Code Programming benefits from CNC Operation
            ]
            ...
            skill_equipment_mappings = [
                (
                    "skill-1",
                    "eq-1",
                ),  # 3D Printer Operation -> Prusa i3 MK3S #1
