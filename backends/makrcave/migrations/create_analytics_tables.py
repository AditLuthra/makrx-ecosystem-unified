...
def main():
    ...
    print(
        "  python create_analytics_tables.py --sample       # Create tables with sample data"
    )
    print(
        "  python create_analytics_tables.py --reset        # Reset and recreate tables"
    )
    print(
        "  python create_analytics_tables.py --reset --sample  # Reset and add sample data"
    )
    print(
        "  python create_analytics_tables.py --drop         # Drop all analytics tables"
    )
