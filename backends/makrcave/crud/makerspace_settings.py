...
class MakerspaceSettingsCRUD:
    ...
    def get_by_makerspace_id(
        ...
        return (
            ...
            .filter(MakerspaceSettings.makerspace_id == makerspace_id)
            .first()
        )
    ...
    def get_by_id(self, settings_id: str) -> Optional[MakerspaceSettings]:
        ...
        return (
            self.db.query(MakerspaceSettings)
            .filter(MakerspaceSettings.id == settings_id)
            .first()
        )

    def create(
        self, settings_data: MakerspaceSettingsCreate, created_by: str
    ) -> MakerspaceSettings:
    ...
    def create_default_settings(
        self, makerspace_id: str, makerspace_name: str, created_by: str
    ) -> MakerspaceSettings:
        """Create default settings for a new makerspace"""
        default_data = MakerspaceSettings.get_default_settings(
            makerspace_id, makerspace_name
        )
    ...
    def update(
        ...
        # Handle allowed_print_technologies conversion
        if (
            "allowed_print_technologies" in update_dict
            and update_dict["allowed_print_technologies"]
        ):
    ...
    def update_section(
        ...
        if section == "general":
            return self._update_general_information(
    ...
    def toggle_feature(
        self, makerspace_id: str, feature: str, enabled: bool, updated_by: str
    ) -> Optional[MakerspaceSettings]:
    ...
    def import_settings(
        ...
        if db_settings and not overwrite:
            raise ValueError(
                "Settings already exist. Use overwrite=True to replace them."
            )
    ...
    def _update_general_information(
        self,
        db_settings: MakerspaceSettings,
        data: Dict[str, Any],
        updated_by: str,
    ) -> MakerspaceSettings:
    ...
    def _update_inventory_settings(
        ...
        inventory_fields = [
            "filament_deduction_enabled",
            "minimum_stock_alerts",
            "stock_threshold_notification",
            "allow_personal_consumables",
            "store_inventory_sync",
    ...
    def _update_billing_config(
        ...
        billing_fields = [
            ...
            "show_job_cost_estimates",
            "default_tax_percent",
            "default_currency",
            "razorpay_key_override",
            "stripe_key_override",
