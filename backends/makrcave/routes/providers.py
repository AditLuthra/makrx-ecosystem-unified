...
async def register_provider(
    ...
    try:
        ...
        provider = ServiceProvider(
            ...
            available_materials=[InputSanitizer.sanitize_text(m) for m in registration.available_materials],
            quality_levels=[InputSanitizer.sanitize_text(q) for q in registration.quality_levels],
            ...
            location={k: InputSanitizer.sanitize_text(v) for k, v in registration.location.items()},
...
async def dispatch_job(
    ...
    try:
        ...
        job = ServiceJob(
            ...
            notes=InputSanitizer.sanitize_text(job_request.special_instructions) if job_request.special_instructions else None,
            created_at=datetime.utcnow(),
            updated_at=datetime.utcnow()
        )
