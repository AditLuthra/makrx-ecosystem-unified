...
@router.post(
    "/usage-metrics/",
    response_model=EnhancedUsageMetricsResponse,
...
@router.post(
    ...
    response_model=EquipmentUtilizationMetricsResponse,
    status_code=status.HTTP_201_CREATED,
)
...
@router.get(
    "/equipment-utilization/",
    response_model=List[EquipmentUtilizationMetricsResponse],
)
...
@router.post(
    "/revenue-analytics/",
    response_model=RevenueAnalyticsEnhancedResponse,
    status_code=status.HTTP_201_CREATED,
)
...
@router.get(
    "/revenue-analytics/",
    response_model=List[RevenueAnalyticsEnhancedResponse],
)
...
@router.post(
    "/engagement-metrics/",
    response_model=MemberEngagementMetricsResponse,
    status_code=status.HTTP_201_CREATED,
)
...
@router.get(
    "/engagement-metrics/",
    response_model=List[MemberEngagementMetricsResponse],
)
...
async def update_analytics_alert(
    ...
    alert = crud_analytics.update_alert(
        db, alert_id, alert_update, current_user.user_id
    )
    if not alert:
        raise HTTPException(
...
@router.post(
    "/configuration/",
    response_model=AnalyticsConfigurationResponse,
    status_code=status.HTTP_201_CREATED,
)
