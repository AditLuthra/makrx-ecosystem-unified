...
class PerformanceBenchmark(Base):
    ...
    )  # utilization, revenue, engagement
    ...
    trend_direction = Column(String(20), nullable=True)
    achievement_status = Column(
        String(20), nullable=False
    )  # exceeded, met, below, critical
...
Index(
    "idx_usage_metrics_makerspace_period",
    EnhancedUsageMetrics.makerspace_id,
    EnhancedUsageMetrics.period,
    EnhancedUsageMetrics.timestamp,
)
Index(
    "idx_equipment_utilization_equipment_date",
    EquipmentUtilizationMetrics.equipment_id,
    EquipmentUtilizationMetrics.date,
)
Index(
    "idx_revenue_enhanced_makerspace_date",
    RevenueAnalyticsEnhanced.makerspace_id,
    RevenueAnalyticsEnhanced.transaction_date,
)
Index(
    "idx_engagement_member_date",
    MemberEngagementMetrics.member_id,
    MemberEngagementMetrics.analysis_date,
)
Index(
    "idx_analytics_alerts_active",
    AnalyticsAlert.makerspace_id,
    AnalyticsAlert.is_active,
    AnalyticsAlert.severity,
)
Index(
    "idx_performance_benchmarks_type",
    PerformanceBenchmark.makerspace_id,
    PerformanceBenchmark.benchmark_type,
    PerformanceBenchmark.measurement_date,
)
