...
class MembershipPlan(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "discount_start_date": (
                self.discount_start_date.isoformat()
    ...
    def get_effective_price(self, promo_code: str = None, current_date=None):
        ...
        if (
            ...
            and (
                self.discount_start_date is None
    ...
    def get_display_features(self):
        ...
        if self.guest_passes_per_cycle > 0:
            auto_features.append(
                f"{self.guest_passes_per_cycle} guest passes per {self.billing_cycle.value}"
            )
    ...
    def get_default_plans(cls, makerspace_id: str):
        ...
        return [
            ...
            },
            {
                ...
                "features": [
                    "24/7 access",
                    "All equipment including premium",
                    "Dedicated storage",
                    "Guest privileges",
                    "Priority support",
                ],
