...
class ErrorHandlingMiddleware(BaseHTTPMiddleware):
    ...
    async def handle_exception(self, request: Request, exc: Exception, request_id: str, start_time: float) -> JSONResponse:
    ...
    async def _handle_api_error(self, exc: APIError, request_id: str, request: Request, process_time: float) -> JSONResponse:
        logger.warning(
    ...
    async def _handle_validation_error(self, exc: RequestValidationError, request_id: str, request: Request, process_time: float) -> JSONResponse:
        field_errors = {}
    ...
    async def _handle_http_exception(self, exc: FastAPIHTTPException, request_id: str, request: Request, process_time: float) -> JSONResponse:
        error_code_map = {
    ...
    async def _handle_unexpected_error(self, exc: Exception, request_id: str, request: Request, process_time: float) -> JSONResponse:
        logger.error(
...
async def validation_exception_handler(request: Request, exc: RequestValidationError) -> JSONResponse:
    ...
    return JSONResponse(
        ...
        content={
            "error": {
                "message": "Request validation failed",
                "code": ErrorCode.VALATION_ERROR if False else ErrorCode.VALIDATION_ERROR,
                "field_errors": field_errors,
                "request_id": request_id,
                "timestamp": time.time(),
            }
