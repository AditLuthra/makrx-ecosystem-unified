...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://makrx_services:password@localhost/makrx_services")
    
    # Redis
    REDIS_URL: str = os.getenv("REDIS_URL", "redis://localhost:6379/2")
    
    # Cross-platform integration
    STORE_API_URL: str = os.getenv("STORE_API_URL", "http://localhost:8004/api")
    SERVICES_API_URL: str = os.getenv("SERVICES_API_URL", "http://localhost:8006/api")
    ...
    S3_BUCKET_NAME: str = os.getenv("S3_BUCKET_NAME", "makrx-services-files")
    ...
    MINIO_BUCKET: str = os.getenv("MINIO_BUCKET", "makrx-services")
    ...
    # Job processing
    JOB_DISPATCH_INTERVAL: int = int(os.getenv("JOB_DISPATCH_INTERVAL", "30"))  # seconds
    MAX_PROVIDER_NOTIFICATIONS: int = int(os.getenv("MAX_PROVIDER_NOTIFICATIONS", "5"))
