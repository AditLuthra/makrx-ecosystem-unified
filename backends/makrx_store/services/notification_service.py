...
class NotificationService:
    ...
    async def send_notification(
        ...
        try:
            ...
            if request.notification_type == NotificationType.EMAIL:
                ...
                raise ValueError(
                    f"Unsupported notification type: {request.notification_type}"
                )
    ...
    def _check_user_preferences(self, request: NotificationRequest) -> bool:
        ...
        if request.category == NotificationCategory.PROMOTIONAL:
            ...
            NotificationCategory.SAFETY_ALERT,
...
async def send_order_confirmation(
    order_data: Dict[str, Any], customer_email: str
) -> NotificationResponse:
...
async def send_payment_success(
    payment_data: Dict[str, Any], customer_email: str
) -> NotificationResponse:
...
async def send_quote_ready(
    quote_data: Dict[str, Any], customer_email: str
) -> NotificationResponse:
