...
from ..core.enhanced_security_auth import (
...
from ..core.operational_security import (
    secrets_manager,
    mfa_manager,
    access_control,
)
from ..core.payment_security import payment_processor
...
async def request_data_export(
    ...
    try:
        ...
        target_user_id = (
            user_id
            if user_id and "admin" in current_user.roles
...
async def withdraw_consent(
    ...
    try:
        ...
        result = await consent_manager.withdraw_consent(
            target_user_id, consent_enum, reason
        )
