...
from middleware.observability import (
    audit,
    metrics,
    track_quote_to_order_conversion,
)
...
async def complete_upload(
    ...
    try:
        ...
        file_info = {
            "dimensions_mm": {"x": 85.2, "y": 54.7, "z": 12.3},
            "volume_mm3": 12847.5,
...
def calculate_3d_print_pricing(
    ...
    material_rates = {"PLA": 2.5, "ABS": 3.0, "PETG": 3.5, "TPU": 4.0}
    ...
    return {
        ...
        "estimated_weight_g": round(
            volume_cm3 * 1.24 * (infill_percentage / 100) * quantity, 2
        ),  # PLA density
