...
class Review(Base):
    ...
    responses = relationship(
        "ReviewResponse", back_populates="review", cascade="all, delete-orphan"
    )
...
class ReviewFlag(Base):
    ...
    flag_type = Column(
        String(50), nullable=False
    )  # spam, fake, inappropriate, offensive
    reason = Column(Text)
