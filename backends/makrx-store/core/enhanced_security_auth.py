...
from jose.exceptions import ExpiredSignatureError, JWTClaimsError, JWTError, JWTSignatureError, JWTIssuerError, JWSError
...
class EnhancedAuth:
    ...
    self.redis_client = AsyncRedis.from_url(getattr(settings, 'REDIS_URL', None)) if getattr(settings, 'REDIS_URL', None) else None
