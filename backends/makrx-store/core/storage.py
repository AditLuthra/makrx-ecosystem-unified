    ...
    def _create_client(self):
        ...
        try:
            ...
            try:
                ...
                logger.warning("S3 credentials not configured; skipping bucket head check")
...
async def upload_file_to_storage(file_obj: BinaryIO, filename: str, prefix: str = "uploads") -> str:
    storage = get_storage()
    if not storage:
