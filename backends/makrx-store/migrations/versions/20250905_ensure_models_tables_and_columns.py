...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['product_id'], ['store_products.id'], name='fk_product_tags_product'),
        sa.ForeignKeyConstraint(['tag_id'], ['store_tags.id'], name='fk_product_tags_tag'),
    ...
    op.create_table(
        ...
        sa.Column('featured_categories', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False),
        sa.Column('is_featured', sa.Boolean(), server_default=sa.text('false'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('NOW()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['collection_id'], ['store_collections.id'], name='fk_collection_products_collection'),
        sa.ForeignKeyConstraint(['product_id'], ['store_products.id'], name='fk_collection_products_product'),
